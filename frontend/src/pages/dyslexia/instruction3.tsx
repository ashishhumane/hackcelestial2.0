 ...
 const speak = useCallback(
  ...
  useEffect(() => {
    ...
    const instructionText = `
      Welcome to Similar Word game.
      Similar sounding words will appear on your screen.
      Listen carefully and mark the correct words.
      You have sixty seconds to complete the challenge.
      Each correct word increases your score.
      But be careful, wrong selections will reduce your points.
  ...
  const startGame = () => {
    alert("Game starting! (In your actual app, this would navigate to the similar word game)");
  };
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        ...
        >
          ...
          <ul className="text-lg space-y-3 text-cyan-200 text-left mb-8 list-disc list-inside">
            <li>🔊 Similar sounding words will appear on your screen.</li>
            <li>👂 Listen carefully and mark the correct words.</li>
            <li>⏳ You have 60 seconds to complete the challenge.</li>
            <li>🎯 Each correct word increases your score.</li>
            <li>❌ Wrong selections will reduce your points.</li>
          </ul>
          <button
            onClick={startGame}
